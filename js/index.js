            ...
            t.onclick = () => {
                if (t.getAttribute('class') != 'device_box-nav_con acc') {
                    ...
                    if (t.getAttribute('index') == '1') {
                        ...
                        <div style="display: flex;align-items: start;padding: 10px 0;gap: 10px;">
                                    <span style="color:var(--color-text)">* </span>
                                    <p style="flex: 1;color:var(--color-text);    cursor: pointer;"> Xem thêm về thiết
                                        bị
                                        dự thi vòng sơ loại</p>
                                </div>`
